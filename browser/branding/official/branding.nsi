...
!define BrandFullNameInternal "HuskyNZ"
!define BrandFullName         "HuskyNZ"
!define CompanyName           "HuskyNZ"
!define URLInfoAbout          "https://www.husky.nz"
!define URLUpdateInfo         "https://www.husky.nz/firefox/${AppVersion}/releasenotes"
...
!define OFFICIAL
!define URLStubDownloadX86 "https://serv.husky.nz/?os=win&lang=${AB_CD}&product=firefox-latest"
!define URLStubDownloadAMD64 "https://serv.husky.nz/?os=win64&lang=${AB_CD}&product=firefox-latest"
!define URLStubDownloadAArch64 "https://serv.husky.nz/?os=win64-aarch64&lang=${AB_CD}&product=firefox-latest"
!define URLManualDownload "https://www.husky.nz/${AB_CD}/firefox/installer-help/?channel=release&installer_lang=${AB_CD}"
!define URLSystemRequirements "https://www.husky.nz/firefox/system-requirements/"
